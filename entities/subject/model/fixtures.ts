...
| **Пример**                        | function sum(a, b) { return a + b; }                        | const sum = function (a, b) { return a + b; }      | const sum = (a, b) => a + b;                                         |
      ...
      },
      {
        ...
        description: "Погружение (capturing) — событие идёт сверху вниз: от window → document → body → … → к самому вложенному элементу. Всплытие (bubbling) — после этого событие идёт снизу вверх: от целевого элемента → родителя → … → до document.",
        code: [
          {
            lang: "js",
