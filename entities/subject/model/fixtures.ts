...
TypeScript Server (tsserver) — это специальный процесс, который идёт вместе с TypeScript-пакетом (typescript npm-пакет)
и работает «за кулисами» в редакторе.
    ...
    rules: [
      {
        ...
        label: "Что происходит после того, как ты вводишь URL в адресную строку браузера и жмёшь Enter.",
        code: [{
          content: `
🔄 Пошаговый процесс
